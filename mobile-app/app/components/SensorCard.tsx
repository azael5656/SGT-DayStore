 ...
 * El color del valor cambia segun el tipo y un umbral simple:
 *  - temperatura > 28 C en rojo
 *  - puerta abierta (valor 1) en rojo
 *  - movimiento reciente en naranja
 *  - todo lo demas en verde
 */
...
function colorValor(tipo: string, valor: number): string {
  ...
  if (tipo === 'puerta' && valor === 1) return COLORS.danger;
